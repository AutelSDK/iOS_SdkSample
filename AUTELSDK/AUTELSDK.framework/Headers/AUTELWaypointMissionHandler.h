...
/**
*  @brief Upload the mission execution file, which is generated by AUTEL route planning algorithm.
*
*  上传任务执行任务文件
*
*  @param completion Completion block.
...
*  命令结束回调
*/
- (void)uploadMissionFile:(NSString *_Nonnull)path withProgress:(AUTELProgressHandler)progress withCompletion:(AUTELCompletionBlock)completion;
